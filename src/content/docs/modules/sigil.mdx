...
:::tip[Where Sigil shows up]
Every Katafract app uses Sigil tokens. Start with [Wraith](/apps/wraith/getting-started/) or [Vaultyx](/apps/vaultyx/getting-started/) for the user-facing flow.
:::
