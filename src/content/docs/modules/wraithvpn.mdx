---
title: WraithVPN
description: WireGuard-based VPN served by ten Katafract-operated exit nodes. Included in Enclave and Sovereign tiers.
---

:::tip[Using the Wraith app?]
This page covers protocol and architecture. For the user-facing how-to, see [Wraith — getting started](/apps/wraith/getting-started/).
:::

WraithVPN is the VPN layer of the Katafract platform. WireGuard under the hood, served by ten exit nodes the company operates directly, with a Shadowsocks + v2ray-plugin fallback for environments that block WireGuard.
