...
:::tip[Using Haven directly?]
This page covers resolver architecture and protocol. For the user-facing how-to, see [Haven — getting started](/apps/haven/getting-started/).
:::
