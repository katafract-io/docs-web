...
:::tip[Using the Vaultyx app?]
This page covers protocol and architecture. For the user-facing how-to, see [Vaultyx — getting started](/apps/vaultyx/getting-started/).
:::
