...
Public repos, bootstrap scripts, and configs that stand up the fleet are on our GitHub org: [`github.com/katafract-io`](https://github.com/katafract-io). Reading them is the best way to understand what Katafract actually runs before reporting.
